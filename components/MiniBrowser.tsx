...
export default function MiniBrowser({ url, height = 540 }: MiniBrowserProps) {
  ...
  return (
    <div className="rounded-xl overflow-hidden border border-subtle bg-surface shadow-[0_24px_64px_-16px_rgba(0,0,0,0.55)]">
      {/* Browser chrome */}
      <div className="flex items-center gap-3 px-4 h-11 border-b border-subtle bg-surface">
        {/* Traffic lights */}
        ...
        {/* URL bar */}
        <div className="flex flex-1 items-center gap-2 rounded-md px-3 py-1.5 bg-background/60 border border-subtle min-w-0">
          <svg
            width="10"
            height="10"
            viewBox="0 0 24 24"
          ...
          <div className="flex items-center gap-1.5 ml-auto shrink-0">
            ...
            />
            <span className="text-xs text-dim tracking-wide">live</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="text-dim hover:text-foreground transition-colors duration-200"
          >
            <svg
              width="13"
              height="13"
